                ...
                <div class="p-4 sm:p-6 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition duration-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Développeur / Candidat sur Talentia</p>
                    ...
                    <div class="flex items-center space-x-2">
                        @if($friend->status == 'pending')
                            <button class="text-gray-500 font-bold hover:bg-gray-100 px-4 py-1.5 rounded-full text-sm transition">
                                Ignorer
                            </button>
                            <button class="bg-[#0a66c2] text-white font-bold px-4 py-1.5 rounded-full text-sm hover:bg-[#004182] transition">
                                Accepter
                            </button>
                        @else
